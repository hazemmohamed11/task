              ...
              <div class="card-body">
                <form class="" action="add.php" method="post" enctype="multipart/form-data">
                    ...
                    <label for="name_ar">Name_AR</label>
                      <input type="text" class="form-control" name="name_ar"  placeholder="Enter Name" value="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="Date" class="form-control" name="EndDate" placeholder="Enter End Date" value="">
                    </div>
                    <div class="form-group">
